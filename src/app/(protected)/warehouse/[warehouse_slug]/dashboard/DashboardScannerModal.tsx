...
import { StockUnitDetailsContent, type StockUnitWithProduct } from '@/components/layouts/stock-unit-details-content';
...
export function DashboardScannerModal({
	...
	const [scannedStockUnit, setScannedStockUnit] = useState<StockUnitWithProduct | null>(null);
						...
						<DrawerTitle>
							{scannedStockUnit ? (
								<>
									...
									<StockStatusBadge status={scannedStockUnit.status as StockUnitStatus} />
								</>
							) : (
								'Scan Stock Unit'
							)}
