...
export function StockFlowTab({ inwardItems, outwardItems, measuringUnit }: StockFlowTabProps) {
	...
	if (allFlows.length === 0) {
		return (
			<div className="flex flex-col items-center justify-center py-12 px-4">
				...
				<h3 className="text-lg font-medium text-gray-900 mb-1">No stock flow</h3>
