			...
			>
				<div className="space-y-3">
					<div className="flex justify-between text-sm">
						...
						<span className="font-semibold text-gray-700">{getStockTypeDisplay(product.stock_type)}</span>
					</div>
					<div className="flex justify-between text-sm">
				...
				<div className="space-y-3">
					...
					{product.gsm && (
						<div className="flex justify-between text-sm">
							...
							<span className="font-semibold text-gray-700">{product.gsm} gm/m²</span>
						</div>
					)}
					{product.thread_count_cm && (
						<div className="flex justify-between text-sm">
							<span className="text-gray-700">Thread count</span>
							<span className="font-semibold text-gray-700">{product.thread_count_cm} TPI</span>
						</div>
					)}
					{product.hsn_code && (
						<div className="flex justify-between text-sm">
							<span className="text-gray-700">HSN code</span>
							<span className="font-semibold text-gray-700">{product.hsn_code}</span>
						</div>
					)}
				</div>
			</Section>
