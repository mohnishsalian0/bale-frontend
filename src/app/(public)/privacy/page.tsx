        ...
        <div className="bg-white rounded-lg shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-gray max-w-none space-y-6 text-gray-700">
            <section>
              ...
              <p>
                This Privacy Policy describes how <strong>Bale</strong> and its affiliates (collectively &quot;Bale, we, our, us&quot;)
                collect, use, share, protect or otherwise process your information/personal data through our website{" "}
                <strong>www.baleapp.in</strong> (hereinafter referred to as Platform). Please note that you may be able to browse
            ...
            <section>
              ...
              <p className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-500">
                <strong>Security Notice:</strong> If you receive an email, a call from a person/association claiming to be Bale
            ...
            <section>
              ...
              <p>
                ...
                or delay deletion of the account. Once the account is deleted, you will lose access to the account.
              </p>
              <p>
                We retain your personal data information for a period no longer than is required for the purpose for which it
