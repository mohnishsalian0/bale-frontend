...
export const metadata: Metadata = {
  title: "Privacy Policy | Bale",
  description: "Privacy policy for Bale inventory management platform",
};
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-gray max-w-none space-y-6 text-gray-700">
            <section>
              ...
              <p>
                This Privacy Policy describes how <strong>Bale</strong> and its
                affiliates (collectively &quot;Bale, we, our, us&quot;) collect,
                use, share, protect or otherwise process your
                information/personal data through our website{" "}
                <strong>www.baleapp.in</strong> (hereinafter referred to as
                ...
                offer any product/service under this Platform outside India and
            ...
            <section>
              ...
              <p>
                ...
                such information shared as proof of identity or address. Some of
                the sensitive personal data may be collected with your consent,
                such as your bank account or credit or debit card or other
                payment instrument information or biometric information such as
                your facial features or physiological information (in order to
              ...
              <p>
                ...
                business partner&apos;s privacy practices or the content of
              ...
              <p className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-500">
                <strong>Security Notice:</strong> If you receive an email, a
                call from a person/association claiming to be Bale seeking any
            ...
            <section>
              ...
              <p>
                We may disclose personal and sensitive personal data to
                government agencies or other authorised law enforcement agencies
            ...
            <section>
              ...
              <p>
                ...
                in your subject line of your communication. We may verify such
            ...
            <section className="mt-8 pt-8 border-t border-gray-200">
              ...
              <div className="space-y-2">
                <p>
                  <strong>Name:</strong> Chirag Bolar
                </p>
                <p>
                  <strong>Designation:</strong> Founder
                </p>
                <p>
                  <strong>Company:</strong> Bale
                </p>
                <p>
                  <strong>Address:</strong> B48, KALPANA, Shree Mahalakshmi CHS,
                  Veera Desai Road, Andheri W, Mumbai 400058
                </p>
                <p>
                  <strong>Phone:</strong>{" "}
                  <a
