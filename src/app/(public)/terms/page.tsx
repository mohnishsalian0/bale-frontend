...
export const metadata: Metadata = {
  title: "Terms & Conditions | Bale",
  description: "Terms and conditions for using Bale inventory management platform",
};
          ...
          <div className="prose prose-gray max-w-none space-y-6 text-gray-700">
            ...
            <section>
              <p>
                ...
                <strong>www.baleapp.in</strong> (&apos;Website&apos;), including the related mobile site and mobile
            ...
            <section>
              <p>
                The Platform is owned by <strong>Bale</strong>, with its registered office at{" "}
                <strong>B48, KALPANA, Shree Mahalakshmi CHS, Veera Desai Road, Andheri W, Mumbai 400058</strong>{" "}
            ...
            <section>
              ...
              <ol className="list-decimal list-inside space-y-4">
                ...
                <li>
                  ...
                  jurisdiction of the courts in <strong>Mumbai, Maharashtra</strong>.
                </li>
                <li>
