...
export default function ImageWrapper({
	...
	if (imageUrl) {
		return (
			<div className={cn(imageWrapperVariants({ size, shape }), 'relative overflow-hidden')}>
				<Image
					src={imageUrl}
					alt={alt}
					fill
	...
	return (
		<div className={cn(imageWrapperVariants({ size, shape }), 'bg-gray-100 flex items-center justify-center')}>
			{renderPlaceholder()}
		</div>
	);
}
