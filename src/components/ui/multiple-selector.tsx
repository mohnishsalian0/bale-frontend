  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "flex items-start justify-between rounded-md border border-input px-3 py-2.5 text-base ring-offset-background focus-within:border-ring focus-within:ring-ring/50 focus-within:ring-[3px] md:text-sm",
        ...
        <div className="relative">
          {open && (
            <CommandList
              className="absolute top-1 z-10 w-full rounded-md border border-border bg-background text-popover-foreground shadow-gray-md outline-none animate-in"
