...
function getProductStatusConfig(status: ProductStockStatus): ProductStatusConfig {
	switch (status) {
		case 'in_stock':
...
export function ProductStockStatus({ status, className }: ProductStatusBadgeProps) {
