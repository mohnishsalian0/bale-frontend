 ...
 */
export function transformProductWithAttributes(product: any): ProductWithAttributes {
 ...
 */
export async function getProductByIdWithAttributes(productId: string): Promise<ProductWithAttributes | null> {
	const supabase = createClient();
